...
<head>
    ...
    <title>Master Supplier - Pencatatan ATK</title>
    <link rel="stylesheet" href="{{ asset('assets/css/masterSupplier.css') }}">
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu-section">
            ...
            <a href="/masterSupplier" class="menu-item active">
                <svg fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div class="page-info">
                ...
                <p>Kelola semua master Supplier</p>
            </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 120px;">Kode Supplier</th>
                        <th>Nama Supplier</th>
                        <th>PIC / Contact</th>
                        <th>Alamat</th>
                        <th>Email</th>
    ...
    <div id="addModal" class="modal-overlay">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalTitle">Tambah Supplier Baru</h2>
