...
<head>
    ...
    <title>Dashboard - Pencatatan ATK</title>
    <link rel="stylesheet" href="{{ asset('assets/css/dashboardPage.css') }}">
</head>
<body>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="menu-section">
            <a href="/dashboardPage" class="menu-item active">
                <svg fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Ringkasan</p>
        </div>
        ...
        <div class="stats-grid">
            ...
            <!-- Pengambilan Disetujui Hari Ini -->
            <div class="stat-card">
                <div class="stat-info">
        ...
        <div class="activity-section">
            ...
            <div class="activity-list">
                ...
                <div class="activity-item">
                    ...
                    <span class="activity-status approved">disetujui</span>
                </div>
                ...
                <div class="activity-item">
                    ...
                    <span class="activity-status pending">menunggu</span>
                </div>
                ...
                <div class="activity-item">
                    ...
                    <span class="activity-status rejected">ditolak</span>
                </div>
